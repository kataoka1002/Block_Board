...
> * ### ゲーム内容
>    - #### プレイヤーが板を置いたり壊したりしながら相手の敷地に侵入するパズルゲームです。
> * ### プレイ人数　　　　　
...
> 
> ## ＜板＞
>> * #### 配列を使うことで板を複数作成しています。板とキャラクターに自分の座標を覚えさせて、
>> #### 　　キャラクター座標と板座標を比べることで移動できるかできないかを判断しています。
>> #### 　　板は自分も相手もすり抜けることが出来ないので30枚をまとめて管理しています。
>> |板のナンバー|X座標|Z座標|Y座標|
>> |------------|-----|----|-----|
>> |0|60|80|5|
>> |1|40|20|5|
...
>> |29|80|60|5|
>> 
>>  ※1人15枚の板を置けるので、合わせて30個分の配列を準備しています。
>>  
>> <br />
>> 
>> * #### 板は置いた直後のターンでは壊せないので、それを分かりやすくするために壊せる板と壊せない板で
